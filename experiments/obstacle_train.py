...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--classifier-out", type=Path,
                        default=Path("obstacle_classifier.pkl"))
    parser.add_argument("--encoder-out", type=Path, default=Path("label_encoder.pkl"))
